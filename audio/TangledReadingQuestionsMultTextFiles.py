#The following script searches files in the path directory noted by the variable path and converts the text to speech.  Please only insert .txt files in the directory.
